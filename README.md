# 👨‍💻 Aaron Vandhana – IT Portfolio

Welcome to my IT home lab portfolio. I'm an aspiring IT professional building hands-on experience through self-directed projects that simulate real-world Help Desk and systems administration scenarios.

This repository documents each project end-to-end — including planning, implementation, troubleshooting, and key takeaways — to demonstrate practical knowledge alongside any certifications or coursework.

---

## 🙋 About Me

I'm actively pursuing a career in entry-level IT and Help Desk support. My focus is on building a strong technical foundation through hands-on lab work covering virtualization, operating systems, networking, and system administration.
...
Each project lives in its own folder and contains a detailed README documenting:

- **Objective** – What the project set out to accomplish
- **Tools Used** – Software, platforms, and utilities involved
- **Step-by-Step Process** – Phases of planning, setup, and execution
- **Troubleshooting** – Real problems encountered and how they were resolved
- **Key Takeaways** – What was learned and how it applies to real IT work
...
*This portfolio is actively growing as I complete new projects. Check back for updates.*
